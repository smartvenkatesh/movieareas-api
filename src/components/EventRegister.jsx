...
const EventRegister = () => {
  ...
  const handleSave=()=>{
    ...
    axios.post("http://localhost:8080/events/home",encrypted,{
      headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    })
    .then((res)=>{
      setWait(res.data.message)
      navigate("/home")
    }).catch((err)=>console.log(err))
  }
  return (
    <div className='register-top'>
      <h1>Register Event Form</h1>
      <form className='register-event'>
        ...
        >
         ...
         <Button variant='contained' color='success' onClick={handleSave}>Create Event</Button>
